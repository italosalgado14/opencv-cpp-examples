...
{
    // Open image
    cv::Mat image= cv::imread("/home/laila/programacion/C++/openCV/44_countingPixels2/000001.png",0);
    // define image roi
    int xo=295, yo=52;
    int width=51, height=144;
    ...
    cv::Mat secondImage= cv::imread("/home/laila/programacion/C++/openCV/44_countingPixels2/000653.png",0);
    if (!secondImage.data)
        return 0;
