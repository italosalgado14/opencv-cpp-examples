...
{
    // Read input image
    cv::Mat image= cv::imread("/home/laila/programacion/C++/openCV/53_segmentingWS/apples.png");
    if (!image.data)
        return 0;
    ...
    // Get the binary map
    cv::Mat binary;
    binary= cv::imread("/home/laila/programacion/C++/openCV/53_segmentingWS/result.png",0);
    ...
    // Open another image
    image= cv::imread("/home/laila/programacion/C++/openCV/53_segmentingWS/apples.png");
