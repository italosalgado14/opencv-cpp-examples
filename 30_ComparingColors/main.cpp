...
int main()
{
    ...
    // 2. Read input image
    cv::Mat image= cv::imread("/home/laila/programacion/C++/openCV/30_ComparingColors/apples.png");
    if (image.empty())
        return 0;
    ...
    cdetect.setTargetColor(0,100,0); // here green
    ...
    ColorDetector colordetector(100, 150, 0,  // color
                                70, true); // Lab threshold
    ...
    cv::Mat img, res, element;
    cv::namedWindow( "Meanshift", 0 );
    img = cv::imread("/home/laila/programacion/C++/openCV/30_ComparingColors/apples.png");
